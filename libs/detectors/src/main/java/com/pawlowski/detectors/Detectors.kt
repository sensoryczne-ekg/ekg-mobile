package com.pawlowski.detectors

import com.github.psambit9791.jdsp.filter.Butterworth
import com.github.psambit9791.jdsp.misc.UtilMethods
import com.github.psambit9791.jdsp.signal.Convolution
import com.pawlowski.detectors.Utils.MWA
import com.pawlowski.detectors.Utils.absArray
import com.pawlowski.detectors.Utils.addingZeros
import com.pawlowski.detectors.Utils.diffInt
import com.pawlowski.detectors.Utils.meanArray
import com.pawlowski.detectors.Utils.movedDifference
import com.pawlowski.detectors.Utils.positiveFirstDifference
import com.pawlowski.detectors.Utils.positiveMiddleDifference
import com.pawlowski.detectors.Utils.pow2Array
import com.pawlowski.detectors.Utils.searchForMaximumInRange
import com.pawlowski.detectors.Utils.valuesOfIndexes
import java.util.*
...
class Detectors(private val fs: Double) {
    ...
    fun engzeeDetector(
        unfilteredSignal: DoubleArray,
        threshold: Double = 0.0085,
    ): Array<Int> {
        // band-stop 48 - 52 Hz
    ...
    private fun panPeakDetect(
        detection: DoubleArray,
        fs: Double,
    ): Array<Int> {
